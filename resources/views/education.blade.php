...
<header id="header" class="header d-flex align-items-center">
  ...
  <div class="quiz-container">
    <form id="quizForm" class="formulaire">
      @foreach ($questions_education as $index => $question)
  ...
  <script >
      ...
      const totalQuestions = {{ count($questions_education) }};
      ...
      submitButton.addEventListener('click', () => {
        ...
        let score = {{ count($questions_education) }};
        ...
        const correctAnswers = @json($questions_education->pluck('correct', 'id'));
