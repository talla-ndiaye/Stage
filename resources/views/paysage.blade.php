...
<header id="header" class="header d-flex align-items-center">
  ...
  <div class="quiz-container">
    <form id="quizForm" class="formulaire">
      @foreach ($questions_paysage as $index => $question)
  ...
  <script >
      ...
      const totalQuestions = {{ count($questions_paysage) }};
      ...
      submitButton.addEventListener('click', () => {
        ...
        let score = {{ count($questions_paysage) }};
        ...
        const correctAnswers = @json($questions_paysage->pluck('correct', 'id'));
