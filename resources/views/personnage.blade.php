...
<header id="header" class="header d-flex align-items-center">
  ...
  <div class="quiz-container">
    <form id="quizForm" class="formulaire">
      @foreach ($questions_personnage as $index => $question)
  ...
  <script >
      ...
      const totalQuestions = {{ count($questions_personnage) }};
      ...
      submitButton.addEventListener('click', () => {
        ...
        let score = {{ count($questions_personnage) }};
        ...
        const correctAnswers = @json($questions_personnage->pluck('correct', 'id'));
