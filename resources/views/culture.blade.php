...
<header id="header" class="header d-flex align-items-center">
  ...
  <div class="quiz-container">
    <form id="quizForm" class="formulaire">
      @foreach ($questions_culture as $index => $question)
  ...
  <script >
      ...
      const totalQuestions = {{ count($questions_culture) }};
      ...
      submitButton.addEventListener('click', () => {
        ...
        let score = {{ count($questions_culture) }};
        ...
        const correctAnswers = @json($questions_culture->pluck('correct', 'id'));
