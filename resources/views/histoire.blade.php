...
<header id="header" class="header d-flex align-items-center">
  ...
  <div class="quiz-container">
    <form id="quizForm" class="formulaire">
      @foreach ($questions_histoire as $index => $question)
  ...
  <script >
      ...
      const totalQuestions = {{ count($questions_histoire) }};
      ...
      submitButton.addEventListener('click', () => {
        ...
        let score = {{ count($questions_histoire) }};
        ...
        const correctAnswers = @json($questions_histoire->pluck('correct', 'id'));
